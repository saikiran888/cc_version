...
class DualVideoWindow(QDialog):
    ...
    def setup_cell_flags_tab(self):
        ...
        side_controls_layout = QVBoxLayout(side_controls)
        ...
        top_row.addWidget(video_container, alignment=Qt.AlignTop | Qt.AlignLeft)
        top_row.addWidget(side_controls, alignment=Qt.AlignTop)
...
class VideoWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        """)
        left_layout.addWidget(self.pixel_intensity_label)
    ...
    def resizeEvent(self, event):
        ...
        if hasattr(self, "video_label"):
            side = min(self.video_label.parent().width(),
                       self.video_label.parent().height(), 500)
            self.video_label.setFixedSize(side, side)
