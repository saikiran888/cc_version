...
class DualVideoWindow(QDialog):
    ...
    def setup_ui(self):
        ...
        self.player2.setMinimumSize(700, 800)  # Portrait rectangle
        self.player2.setMaximumSize(700, 800)
