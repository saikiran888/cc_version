...
class TIMING_secondary:
    ...
    def secondary(self, DInt, EDInt, ContInt, TimInt, Pix):
        ...
        invalid_0e1t = (df_0E_1T['TarDeath'] == 0).sum()
        alive_0e1t = (df_0E_1T['TarDeath'] == -1).sum()
        valid_0e1t = alive_0e1t - invalid_0e1t
        dead_0e1t = (df_0E_1T['TarDeath'] != -1).sum()
        ...
        invalid_1e0t = (df_1E_0T['tEffDeath'] == 0).sum()
        alive_1e0t = (df_1E_0T['tEffDeath'] == -1).sum()
        valid_1e0t = alive_1e0t - invalid_1e0t
        dead_1e0t = (df_1E_0T['tEffDeath'] != -1).sum()
        ...
        def format_summary_excel(output_path):
            ...
            invalid_0e1t = (df_0e1t['TarDeath'] == 0).sum()
            valid_0e1t = alive_0e1t - invalid_0e1t
            dead_0e1t = (df_0e1t['TarDeath'] != -1).sum()
            ...
            invalid_1e0t = (df_1e0t['tEffDeath'] == 0).sum()
            valid_1e0t = alive_1e0t - invalid_1e0t
            dead_1e0t = (df_1e0t['tEffDeath'] != -1).sum()
