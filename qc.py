...
class SingleVideoPlayer(QWidget):
    ...
    def setup_ui(self):
        ...
        # Video display with navigation buttons
...
class DualVideoWindow(QDialog):
    ...
    def setup_ui(self):
        ...
        # Dual video layout with splitter for resizable videos
        video_splitter = QSplitter(Qt.Horizontal)
        video_splitter.setChildrenCollapsible(False)  # Prevent complete collapse

        # Left video player - 600x600 resizable
        left_group = QGroupBox("Video 1")
        left_layout = QVBoxLayout(left_group)
        self.player1 = SingleVideoPlayer(self, player_id=1)
        # Set default size to 600x600 and make resizable
        self.player1.setMinimumSize(600, 600)  # Minimum size
        self.player1.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        left_layout.addWidget(self.player1)
        video_splitter.addWidget(left_group)

        # Right video player - 600x600 resizable
        right_group = QGroupBox("Video 2")
        right_layout = QVBoxLayout(right_group)
        self.player2 = SingleVideoPlayer(self, player_id=2)
        # Set default size to 600x600 and make resizable
        self.player2.setMinimumSize(600, 600)  # Minimum size
        self.player2.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        right_layout.addWidget(self.player2)
        video_splitter.addWidget(right_group)

        # Set equal sizes for both videos
    ...
    def setup_analysis_overlay_tab(self):
        ...
        self.show_base_checkbox1 = QCheckBox("Show Base (CH0)")
        ...
        controls_layout.addWidget(video1_group)
        ...
        self.show_base_checkbox2 = QCheckBox("Show Base (CH0)")
        ...
        controls_layout.addWidget(video2_group)
        
        layout.addWidget(controls_container)

        # Connect overlay options to individual players
...
class QC_APP(QMainWindow):
    ...
    def select_run_file(self, path_num):
        dialog = QFileDialog()
        start_path = self.default_path if path_num == 1 else ""
